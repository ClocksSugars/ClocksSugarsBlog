...
%% use example i told amor fati for pi types:
%%		another example. say the input type was A, the letters of the alphabet. i could have a normal function A -> W where w is words, and we just send a to apple, b to banana, etc.  but a dependent function can do something like send a to a *particular apple* of type APPLES, or b to a *particular banana* of type BANANAS. the dependent function is sending different inputs to different types
