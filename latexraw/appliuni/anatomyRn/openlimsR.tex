...
\end{label lemma}
\begin{my proof}{m}
This is a nearly trivial statement but worth formalizing regardless. The open interval $(a,b)$ satisfies the property of open sets since for any $x \in (a,b)$, trivially there exists an interval $I \subseteq (a,b)$ which is $I = (a,b)$, meaning that $x \in I$ automatically.
