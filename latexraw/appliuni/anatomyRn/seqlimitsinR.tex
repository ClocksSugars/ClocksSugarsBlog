...
Recall in lemma \ref{lem:RAbsoluteValueProperties} we showed that $|a| \le k$ satisfies $-k \le a \le k$ so we'll use that now on $|b|/2$ and $b_n - b$. This gives us \begin{gather*}
