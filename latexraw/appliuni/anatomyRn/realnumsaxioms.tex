...
\end{align*}
applying commutativity of addition (RNFA2), $c+a = a + c$ but since $c$ is $a$'s additive inverse, this is zero. So what we have shown is that $w + 1 = 0$, or $w + z_\times = 0$ as desired. We may now treat $-a$ as the additive inverse of $a$.
\end{my proof}
