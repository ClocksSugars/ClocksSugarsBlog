...
\end{pmatrix}
\end{align*}
Oof. We can now turn this into a bound but to make that useful we'll have to figure out how we turn our $\sin^2$ terms into their \squote{worst case scenario}s. 
\end{my proof}
