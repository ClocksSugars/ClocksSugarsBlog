...
\begin{my proof}[Proposition: RK2 Does not provide Stability Improvements On Forward Euler]{}
No it can't.
\end{my proof}
\begin{my proof}{m}
...
And my favorite step of this forsaken process is now observing that we can actually apply the heat equation on our real differential operators to swap all instances of $\kappa \nabla^2 T$ with time derivatives of $T$. In addition to that, we can apply a presumption of smoothness to swap the ordering of these differential operators. \begin{gather*}
