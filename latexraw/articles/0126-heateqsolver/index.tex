...
The rest of the features I implemented, including the ability to implement an initial configuration from a CSV, amount to details you can find on my \hyperlink{https://github.com/ClocksSugars/pet_webgpusolver/tree/main}{github repo for this project}.
