...
\frac{T(x,y,t + \Delta t) - T(x,y,t) }{\Delta t} =& \kappa \textstyle{\frac{T(x+\Delta x,y,t) - 2 T(x,y,t) + T(x - \Delta x,y,t)}{\Delta x^2}} \\
&+ \textstyle{\kappa \frac{T(x,y + \Delta y,t) - 2 T(x,y,t) + T(x,y - \Delta y,t)}{\Delta y^2} }
\end{align*}
