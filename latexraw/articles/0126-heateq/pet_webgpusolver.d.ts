...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h4d379c026f0dfc91: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h44feacb8950e2e4e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h88112b9be56a30df: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h3f6b11c35f3bd6c5: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h5407e3a866d9d8da: (a: number, b: number, c: any, d: any) => void;
