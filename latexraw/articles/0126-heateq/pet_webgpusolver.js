...
function wasm_bindgen__convert__closures_____invoke__h4d379c026f0dfc91(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h4d379c026f0dfc91(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h88112b9be56a30df(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h88112b9be56a30df(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h5407e3a866d9d8da(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5407e3a866d9d8da(arg0, arg1, arg2, arg3);
}
 ...
 * @returns {number}
 */
export function get_export_to_num() {
    const ret = wasm.get_export_to_num();
    if (ret[2]) {
 ...
 */
export function get_total_energy_in_one() {
    const ret = wasm.get_total_energy_in_one();
    return ret;
}
 ...
 * @returns {number}
 */
export function give_current_height() {
    const ret = wasm.give_current_height();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
 ...
 * @returns {number}
 */
export function give_current_width() {
    const ret = wasm.give_current_width();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
 ...
 */
export function init_from_csv_buffer() {
    const ret = wasm.init_from_csv_buffer();
    return ret;
}
 ...
 * @returns {boolean}
 */
export function is_receiver_ready() {
    const ret = wasm.is_receiver_ready();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
...
export function junk_current_state() {
    const ret = wasm.junk_current_state();
    if (ret[1]) {
...
/**
 * @param {string} csv_as_string
 * @returns {string}
 */
export function parse_csv(csv_as_string) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(csv_as_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
export function render_a_frame() {
    const ret = wasm.render_a_frame();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {Promise<void>}
 */
export function rinit_with_xy(width, height) {
    const ret = wasm.rinit_with_xy(width, height);
    return ret;
}

export function run_a_compute_iter() {
    const ret = wasm.run_a_compute_iter();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
export function send_output_to_export() {
    const ret = wasm.send_output_to_export();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} maxT
 */
export function update_values(n_times, kappa, delta_t, minT, maxT) {
    const ret = wasm.update_values(n_times, kappa, delta_t, minT, maxT);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 */
export function writeStateAsCSV() {
    const ret = wasm.writeStateAsCSV();
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return wasm_bindgen__convert__closures_____invoke__h5407e3a866d9d8da(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_cast_352b68d98db464b4 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 180, function: Function { arguments: [NamedExternref("GPUUncapturedErrorEvent")], shim_idx: 181, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h3f6b11c35f3bd6c5, wasm_bindgen__convert__closures_____invoke__h88112b9be56a30df);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_cast_d5be308fce034eae = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h44feacb8950e2e4e, wasm_bindgen__convert__closures_____invoke__h4d379c026f0dfc91);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('pet_webgpusolver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
